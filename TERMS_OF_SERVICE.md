...
By downloading or using Wisp ("the app"), you agree to these Terms of Use. If you do not agree, do not use the app.
...
- Provides an AI chat interface for meeting analysis
- Imports and processes audio files
...
- All content you create (recordings, transcriptions, notes) remains **yours**.
- We do not claim ownership of your content.
- We do not access, view, or process your content — it stays on your device.
...
- Circumvent subscription mechanisms or payment systems

## Recording Laws

- Many jurisdictions require consent from all parties before recording a conversation.
- **You are solely responsible** for complying with all applicable laws regarding audio recording in your jurisdiction.
- Wisp does not provide legal advice regarding recording consent.

## Intellectual Property

- Wisp, its design, code, and branding are the intellectual property of Boris Spiro.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, BORIS SPIRO SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING FROM YOUR USE OF THE APP.
...
These terms are governed by the laws of the jurisdiction in which Boris Spiro operates, without regard to conflict of law provisions.
